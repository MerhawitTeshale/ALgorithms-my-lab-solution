...
public class TopologicalSort extends DepthFirstSearch {
	...
	/**
	 * Assumption: g is a DAG. If not, there is no guarantee concerning the nature
	 * of the output.
	 */
	...
	/**
	 * Finds, if possible, a vertex that has no in-vertices and sets this value in
	 * topSortStartVertex If not found, throws an IllegalStateException, indicating
	 * that the input graph is not a DAG.
	 */
